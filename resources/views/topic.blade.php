        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/topic/submit/{{$topic->id}}" method="POST">
                        {{csrf_field()}}
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_1">
                                            ...
                                            <div class="blog-post" style="margin-top: 30px">
                                                        <p class=""><a href="/center/{{$article->user->id}}">{{$article->user->name}}</a> {{$article->created_at->diffForHumans()}}</p>
                            <p class=""><a href="/articles/{{$article->id}}" >{{$article->title}}</a></p>
